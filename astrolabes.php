...
<div>
   ...
   <form method="post" action="">
      <table border="1" cellspacing="0" class="table table-striped table-bordered table-sm table-hover" id="astro-table" width="100%">
         <caption class="title">ASTROLABES</caption>
         <thead style="top:0; background-color:lightgrey;">
            <tr>
               <th width="10%">ID</th>
               <th width="30%">Astrolabe Name (Click on the links to view details)</th>
               <th width="25%">Location</th>
               <th width="25%">Shipwreck</th>
         ...
         <tbody>
            <?php 
               while ($row = mysqli_fetch_array($query))
               {
                   echo '<tr>
                           <td>'.$row['ID'].'</td>                   
                           <td><a href=astroclick.php?astroid='.$row['ID'].'>'.$row['Name'].'</a></td>
                           <td>'.$row['Location'].'</td>      
                           <td>'.$row['Shipwreck'].'</td>                    
                           <td>'.$row['Date Found'].'</td>                       
                        </tr>';
               }?>
         </tbody>
      </table>

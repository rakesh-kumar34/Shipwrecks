<?php
   ...
   $siteclicked = $_GET['sitename'];
   $sql = "SELECT * FROM `pmsimages` WHERE Site_Name='$siteclicked'";
   ...
   <div class="container">
     <?php if($query->num_rows > 0): ?>
		  ...
		  <div class="gallery">
   	    ...
   	    <?php } ?>
        <? else: ?>
        <h4> There are no images to show for this site. Kindly goto Resources->Photos to view all photos.</h4>
        <? endif; ?>
